  ...
  return (
    <>
      ...
      <div className="h-[80%] max-h-[300px] min-h-[300px] p-2 grid grid-cols-3 gap-2">
        <div className="bg-dark-500 hover:bg-dark-600 border border-dark-600 overflow-hidden  rounded col-span-1">
          {list.image && list.image.length > 0 && (
            <img 
        ...
        <div className="bg-dark-500   rounded  col-span-2">
        <div className="info pl-2 pt-2">
