...
function CollaborationPlaylistCard({ playlist }: {playlist : CollabPlaylist}) {
  ...
  return (
    <>
      ...
      <div
        className="card p-2 rounded w-[204px] h-[258px] drop-shadow-md hover:bg-[#e1e2e7] dark:hover:bg-dark-600 hover:bg-gray-300 ease-in-out group relative text-dark-600 dark:text-white"
        onClick={() => {
